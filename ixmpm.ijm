...
macro "ixmpm" {
	...
	html = "<html>"
     +"<h2>ImageXpress Micro Plate Montage About</h2>"
     +"<font size=+1>"
     +"Please visit <a href='https://github.com/ayakimovich/ixmpm'>https://github.com/ayakimovich/ixmpm</a> For the up-to-date version, help or contributing<br><br>"
